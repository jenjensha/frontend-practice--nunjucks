...
class Environment {
    ...
    get isLocal() { return this.get === ENVIRONMENT_LOCAL; }

    get isTest() { return this.get === ENVIRONMENT_TEST; }

    get isAcceptation() { return this.get === ENVIRONMENT_ACCEPTATION; }

    get isProduction() { return this.get === ENVIRONMENT_PRODUCTION; }
